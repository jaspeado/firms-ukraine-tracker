...
OUT_DIR = "."
# CAMBIO CLAVE: Guardamos en GeoJSON para saltarnos los drivers rotos de Linux
...
def main():
    ...
    # Guardado directo en GeoJSON sin usar el motor corrupto de bases de datos
    gdf.to_file(OUT_GEOJSON, driver="GeoJSON")
    print(f"\nArchivo guardado con éxito. Total: {len(gdf)}")
